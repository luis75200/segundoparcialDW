...
for (var i = 0; i < nCantidadLibros; i++){ 
    ...
    var celdaIsbn = document.createElement('td'),
        ...
        celdaMostrar = document.createElement('td'),
        enlaceMostrar = document.createElement('a'),
        enlaceMostrar.href = 'mostrarExistencia.html',
    ...
    var nodoTextoIsbn = document.createTextNode(aIsbn[i]),
        ...
        nodoTextoMostrar = document.createTextNode('Ver inventario'),
        ...
        enlaceMostrar.appendChild(nodoTextoMostrar);
        celdaMostrar.appendChild(enlaceMostrar);
